  ...
  return (
    <div>
      ...
      <div className="flex flex-row relative justify-center items-center space-x-10 bottom-20 px-96">
            ...
            <div className='flex flex-row space-x-5'>
              ...
              <div className='flex flex-col space-y-4' onChange={() => setCheckout}>
                ...
                <div className='flex flex-row space-x-4'>
                  <p>{amount} x</p>
                  <p className='tracking-wider'>({newMap2nd.variant})</p>
                </div>
              </div>
            </div>
              <div className="flex flex-row space-x-6">
                <div className="flex justify-center text-center">
                  <button onClick={onClickDecrease} disabled={amount === 1} className="h-8 w-8 rounded-full bg-yellow-400 text-xl font-black">-</button>
                </div>
                <div className='text-xl font-bold'>
                  {amount}
                </div>
                <div className="flex justify-center text-center">
                  <button onClick={onClickIncrease} disabled={amount > amountData} className="h-8 w-8 rounded-full bg-yellow-400 text-xl font-black">+</button>
                </div>
              </div>
            </div> 
            )
        ...
        <div className="">
          <button onClick={() => handleClickCheckout(checkout, newData)} className="bg-yellow-400 h-44 w-56 rounded-2xl shadow-lg font-black">
            CHECKOUT
          </button>
        </div>
    </div>
