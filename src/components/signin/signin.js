    ...
    <div className='flex-1 flex flex-col'>
      <div className='flex md:flex-row justify-between px-44 py-16'>
        ...
        <div className='signup-btn rounded-full '>
          ...
          )} className='w-52 h-10 text-center primary-text font-bold text-lg'>Sign Up</button>
        </div>
      </div>
      <div className='flex-1 flex flex-col justify-center items-center px-44 space-y-10'>
        ...
        <div onKeyDown={(e) => {
          ...
          <div className='flex flex-col space-y-10'>
            ...
            <input className='h-16 p-5 rounded-lg' type="text" placeholder='Email' onChange={(e) => 
              setSignIn({
                ...signIn,
          ...
          <div className='flex flex-col space-y-10'>
            ...
            <input className='h-16 p-5 rounded-lg' type="password" placeholder='Password' onChange={(e) => 
              setSignIn({
                ...signIn,
          ...
          <div className='space-y-10'>
            <button className='w-full bg-white h-16 rounded-lg' onClick={handleSignIn}>Sign In</button>
            <button className='w-full bg-white h-16 rounded-lg inline-block space-x-5'>
